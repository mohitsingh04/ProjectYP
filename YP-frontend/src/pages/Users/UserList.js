...
export default function UserList() {
    ...
    const columns = [
        ...
        },
        {
            name: "PROFILE",
            selector: (row) => [
                <img src={`http://localhost:5000/images/${row.profile}`} className="rounded-circle" width={50} height={50} alt="profile" />],
            sortable: true,
        },
        {
            name: "CITY",
        ...
        },
        {
            name: "ACTION",
            selector: (row) => [
                <button data-bs-toggle="tooltip" title="View" onClick={() => viewUser(row.uniqueId)}>
                    <i className="fe fe-eye"></i>
                </button>,
                <button data-bs-toggle="tooltip" title="Edit" onClick={() => editUser(row.uniqueId)}>
                    <i className="fe fe-edit"></i>
                </button>,
                <button data-bs-toggle="tooltip" title="Delete" onClick={() => deleteUser(row.uniqueId)}>
