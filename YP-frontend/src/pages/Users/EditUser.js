                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <Card.Body>
                                    <div className="d-flex mb-3">
                                        {previewProfile == ""
                                            ? <img src={`http://localhost:5000/images/${user.profile}`} className="rounded-circle avatar-lg me-2" alt="user avatar" />
                                            : <img src={previewProfile} className="rounded-circle avatar-lg me-2" alt="user avatar" />
                                        }
                                    ...
                                    <Row className="mt-2">
                                        ...
                                        <Col lg={6} md={12} className="mt-2">
                                            <FormGroup>
                                                ...
                                                {errors.role && touched.role ? <small className='text-danger'>{errors.role}</small> : <span />}
                                            </FormGroup>
                                        </Col>
                                    </Row>
                                </Card.Body>
