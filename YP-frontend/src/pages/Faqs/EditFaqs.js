...
export default function EditFaqs() {
    ...
    const onSubmit = async (values) => {
        ...
        API.patch(`/faqs/${uniqueId}`, values).then((response) => {
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <Form.Group className="form-group">
                                            <Form.Control
                                                ...
                                                onBlur={handleBlur}
                                            />
                                            {errors.question && touched.question ? <span className='text-danger'>{errors.question}</span> : <span />}
                                        </Form.Group>
                                    </div>
                                </Col>
                                <Col md={6}>
