                                        ...
                                        <div className="pt-3" id="forgot">
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    onBlur={handleBlur}
                                                />
                                                <span className="text-gray show-hide-reset-password-1" onClick={togglePasswordVisibility}>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    onBlur={handleBlur}
                                                />
                                                <span className="text-gray show-hide-reset-password-2" onClick={toggleConfirmPasswordVisibility}>
