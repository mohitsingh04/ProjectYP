                ...
                <Card.Body>
                    ...
                    <FormGroup>
                        ...
                        <FormControl
                            ...
                            autoComplete="off"
                        />
                        <span className="text-gray show-hide-change-password-1" onClick={toggleOldPasswordVisibility}>
                            {showOldPassword ? <i className="fe fe-eye"></i> : <i className="fe fe-eye-off"></i>}
                        </span>
                    ...
                    <FormGroup>
                        ...
                        <Form.Control
                            ...
                            autoComplete="off"
                        />
                        <span className="text-gray show-hide-change-password-2" onClick={toggleNewPasswordVisibility}>
                            {showNewPassword ? <i className="fe fe-eye"></i> : <i className="fe fe-eye-off"></i>}
                        </span>
                    ...
                    <FormGroup>
                        ...
                        <Form.Control
                            ...
                            autoComplete="off"
                        />
                        <span className="text-gray show-hide-change-password-3" onClick={toggleConfirmPasswordVisibility}>
