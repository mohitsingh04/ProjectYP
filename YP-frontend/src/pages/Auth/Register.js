                                ...
                                <form onSubmit={handleSubmit} className="login100-form validate-form">
                                    ...
                                    <div className="wrap-input100 validate-input">
                                        ...
                                        <span className="symbol-input100">
                                            {errors.name && touched.name ? <i className="mdi mdi-account fixed-icon" aria-hidden="true"></i> : <i className="mdi mdi-account" aria-hidden="true"></i>}
                                        </span>
                                    ...
                                    <div className="wrap-input100 validate-input">
                                        ...
                                        <span className="focus-input100"></span>
                                        <span className="symbol-input100">
                                            {errors.email && touched.email ? <i className="zmdi zmdi-email fixed-icon" aria-hidden="true"></i> : <i className="zmdi zmdi-email" aria-hidden="true"></i>}
                                        </span>
                                    ...
                                    <div className="wrap-input100 validate-input">
                                        ...
                                        <span className="focus-input100"></span>
                                        <span className="symbol-input100">
                                            {errors.mobile_no && touched.mobile_no ? <i className="zmdi zmdi-phone fixed-icon" aria-hidden="true"></i> : <i className="zmdi zmdi-phone" aria-hidden="true"></i>}
                                        </span>
                                    ...
                                    <div className="wrap-input100 validate-input">
                                        <input
                                            ...
                                            autoComplete="off"
                                        />
                                        <span className="text-gray show-hide-password" onClick={toggleConfirmPasswordVisibility}>
                                            {showConfirmPassword ? <i className="fe fe-eye"></i> : <i className="fe fe-eye-off"></i>}
                                        </span>
                                        <span className="focus-input100"></span>
                                        <span className="symbol-input100">
                                            {errors.confirm_password && touched.confirm_password ? <i className="zmdi zmdi-lock fixed-icon" aria-hidden="true"></i> : <i className="zmdi zmdi-lock" aria-hidden="true"></i>}
                                        </span>
                                    ...
                                    <div className="text-center pt-3">
                                        <p className="text-dark mb-0">
                                            ...
                                            <Link to={`${process.env.PUBLIC_URL}/login`} className="text-primary ms-1">
                                                Sign In
                                            </Link>
                                        </p>
                                    </div>
