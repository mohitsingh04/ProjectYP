...
export default function ViewTeacher() {
    ...
    const handleDeleteTeacher = (uniqueId) => {
        Swal.fire({
            title: "Are you sure?",
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    dispatch(showLoading());
                    API.delete(`/teacher/${uniqueId}`).then((response) => {
                        dispatch(hideLoading());
                                    ...
                                    <Row>
                                        ...
                                        <Col lg={12} md={12} xl={6}>
                                            <div className="text-xl-right mt-4 mt-xl-0">
                                                <Link data-bs-toggle="tooltip" title="Edit" to={`/dashboard/edit/teacher/${property_name}/${teacher.uniqueId}`} className="btn btn-primary me-1">
                                                    <span>
                                                        <i className="fe fe-edit"></i>&nbsp;
                                                    </span>
                                                </Link>
                                                <button onClick={() => handleDeleteTeacher(teacher.uniqueId)} data-bs-toggle="tooltip" title="Delete" className="btn btn-danger">
                                                    <span>
