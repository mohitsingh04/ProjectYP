...
export default function CategoryList() {
    ...
    const columns = [
        ...
        },
        {
            name: "ICON",
            selector: (row) => [
                <img src={`http://localhost:5000/images/${row.category_icon}`} width={53} alt="" />
            ],
            sortable: true,
        },
        {
        ...
        },
        {
            name: "Action",
            selector: (row) => [
                <button data-bs-toggle="tooltip" title="View" onClick={() => viewCategory(row.uniqueId)}>
                    <i className="fe fe-eye"></i>
                </button>,
                <button data-bs-toggle="tooltip" title="Edit" onClick={() => editCategory(row.uniqueId)}>
                    <i className="fe fe-edit"></i>
                </button>,
                <button data-bs-toggle="tooltip" title="Delete" onClick={() => deleteCategory(row.uniqueId)}>
            ...
            <div>
                <div className="page-header">
                    ...
                    <div className="ms-auto pageheader-btn">
                        <Link to="/dashboard/category/add/" className="btn btn-primary btn-icon text-white me-3">
                            <span>
