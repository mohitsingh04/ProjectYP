...
export default function EditCategory() {
    ...
    const onSubmit = async (values) => {
        try {
            values = { ...values, "category_description": description || category.description, "userId": User.uniqueId }
            if (typeof values.category_icon == 'object' || typeof values.featured_image == 'object' || typeof values.category_icon != 'object' && values.featured_image != 'object') {
                                ...
                                <div className="form-row">
                                    <div className="form-group col-md-6 mb-3">
                                        <Form.Group>
                                            ...
                                            <input
                                                ...
                                                onBlur={handleBlur}
                                            />
                                            {errors.category_name && touched.category_name ? <span className='text-danger'>{errors.category_name}</span> : <span />}
                                        </Form.Group>
                                    </div>
                                    <div className="form-group col-md-6 mb-3">
                                        <Form.Group>
                                            ...
                                            >
                                                ...
                                                {categories.map((item, key) => (
                                                    <option value={item.uniqueId}>{item.category_name}</option>
                                                ))}
                                            </select>
                                            {errors.parent_category && touched.parent_category ? <span className='text-danger'>{errors.parent_category}</span> : <span />}
                                        </Form.Group>
                                    </div>
                                    ...
                                    <div className="form-group col-md-6 mb-3">
                                        <Form.Group>
                                            ...
                                            {!previewIcon
                                                ?
                                                <img src={`http://localhost:5000/images/${category.category_icon}`} className="mt-1" width="100" alt="" />
                                                :
                                    ...
                                    <div className="form-group col-md-6 mb-3">
                                        <Form.Group>
                                            ...
                                            {!previewFeaturedImage
                                                ?
                                                <img src={`http://localhost:5000/images/${category.featured_image}`} className="mt-1" width="100" alt="" />
