...
export default function AddCourseAeo() {
    ...
    const validationSchema = Yup.object({
        ...
        meta_tags: Yup.string()
            .required('Meta tags is required.'),
        slug: Yup.string()
            .required('Slug is required.'),
        primary_focus_keyword: Yup.string()
            .required('Primary focus keyword is required.'),
        json_schema: Yup.string()
            .required('Json schema is required.'),
    });

    const onSubmit = async (values) => {
        try {
            values = { ...values, "description": description, "course_id": course.uniqueId, "course_name": course.course_name }
            ...
            <div>
                <div className="page-header">
                    ...
                    <div className="ms-auto pageheader-btn">
                        <Link to="/dashboard/course/" className="btn btn-primary btn-icon text-white me-3">
                            <span>
                                ...
                                <Card>
                                    <Card.Header>
                                        ...
                                        <div className="ms-auto pageheader-btn">
                                            {seo.length > 0 && (
                                                <>
                                                    <Link to={`/dashboard/course-seo/edit/${seo[0].uniqueId}`} className="btn btn-primary btn-icon text-white me-3">
                                                        <span>
                                                            <i className="fe fe-edit"></i>&nbsp;
                                                        </span>
                                                        Edit
                                                    </Link>
                                                    <button onClick={() => handleDeleteSeo(seo[0].uniqueId)} className="btn btn-danger">
                                                        <span>
                                            ...
                                            <tbody className="col-lg-12 col-xl-6 p-0">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br />
                                                        {seo[0]?.description && (
                                                            <span>{seo[0]?.description.replace(/<[^>]+>/g, '')}</span>
                                                        )}
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            onBlur={handleBlur}
                                                        />
                                                        {errors.title && touched.title ? <span className='text-danger'>{errors.title}</span> : <span />}
                                                    </div>
                                                </Col>
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            onBlur={handleBlur}
                                                        />
                                                        {errors.meta_tags && touched.meta_tags ? <span className='text-danger'>{errors.meta_tags}</span> : <span />}
                                                    </div>
                                                </Col>
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            onBlur={handleBlur}
                                                        />
                                                        {errors.slug && touched.slug ? <span className='text-danger'>{errors.slug}</span> : <span />}
                                                    </div>
                                                </Col>
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            onBlur={handleBlur}
                                                        />
                                                        {errors.primary_focus_keyword && touched.primary_focus_keyword ? <span className='text-danger'>{errors.primary_focus_keyword}</span> : <span />}
                                                    </div>
                                                </Col>
                                                <Col md={12}>
                                                    <div className="mb-3">
                                                        ...
                                                        <textarea
                                                            ...
                                                            rows="3"
                                                        />
                                                        {errors.json_schema && touched.json_schema ? <span className='text-danger'>{errors.json_schema}</span> : <span />}
