...
import { Col, Row, Card, Form, FormGroup, ListGroup, Breadcrumb, } from "react-bootstrap";
                ...
                <div className="page-header">
                    <div>
                        ...
                        <Breadcrumb className="breadcrumb">
                            ...
                            <Breadcrumb.Item className="breadcrumb-item active breadcrumds" href="#">
                                My Profile
                            </Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                    <div className="ms-auto pageheader-btn">
                        <Link to="/dashboard/my-profile" className="btn btn-primary btn-icon text-white me-3">
                            <span>
                            ...
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                ...
                                <Card.Body>
                                    <div className="d-flex mb-3">
                                        {previewProfile == ""
                                            ? <img src={`http://localhost:5000/images/${user.profile}`} className="rounded-circle avatar-lg me-2" alt="avatar" />
                                            : <img src={previewProfile} className="rounded-circle avatar-lg me-2" alt="avatar" />
                                        }
                                        <div className="ms-auto mt-xl-2 mt-lg-0 me-lg-2">
                                            <input
                                                ...
                                                onBlur={handleBlur}
                                            />
                                            {errors.profile && touched.profile ? <small className='text-danger'>{errors.profile}</small> : <span />}
                                        ...
                                        <Col lg={12} md={12}>
                                            <FormGroup>
                                                ...
                                                <Form.Control
                                                    ...
                                                    onBlur={handleBlur}
                                                />
                                                {errors.name && touched.name ? <small className='text-danger'>{errors.name}</small> : <span />}
                                            </FormGroup>
                                        </Col>
                                    </Row>
                                    ...
                                    <FormGroup className="mt-2">
                                        ...
                                        <Form.Control
                                            ...
                                            disabled
                                        />
                                        {errors.mobile_no && touched.mobile_no ? <small className='text-danger'>{errors.mobile_no}</small> : <span />}
                                    </FormGroup>
                                    <Row className="mt-3">
                                        <Col lg={8} md={12}>
                                            <FormGroup>
                                                ...
                                                <Form.Control
                                                    ...
                                                    onBlur={handleBlur}
                                                />
                                                {errors.address && touched.address ? <small className='text-danger'>{errors.address}</small> : <span />}
                                            </FormGroup>
                                        </Col>
                                        <Col lg={4} md={12}>
                                            <FormGroup>
                                                ...
                                                <Form.Control
                                                    ...
                                                    onBlur={handleBlur}
                                                />
                                                {errors.pincode && touched.pincode ? <small className='text-danger'>{errors.pincode}</small> : <span />}
                                            </FormGroup>
                                        </Col>
                                    </Row>
                                    <Row className="mt-2">
                                        <Col lg={6} md={12}>
                                            <FormGroup>
                                                ...
                                                <Form.Control
                                                    ...
                                                    onBlur={handleBlur}
                                                />
                                                {errors.city && touched.city ? <small className='text-danger'>{errors.city}</small> : <span />}
                                            </FormGroup>
                                        </Col>
                                        <Col lg={6} md={12}>
                                            <FormGroup>
                                                ...
                                                <Form.Control
                                                    ...
                                                    onBlur={handleBlur}
                                                />
                                                {errors.state && touched.state ? <small className='text-danger'>{errors.state}</small> : <span />}
                                            </FormGroup>
                                        </Col>
                                    </Row>
                                </Card.Body>
