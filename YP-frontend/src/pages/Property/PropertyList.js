...
export default function PropertyList() {
    ...
    const columns = [
        ...
        },
        {
            name: "ICON",
            selector: (row) => [
                <img src={`http://localhost:5000/images/${row.property_icon}`} width={53} alt="" />
            ],
            sortable: true,
        },
        {
        ...
        },
        {
            name: "ACTION",
            selector: (row) => [
                <button data-bs-toggle="tooltip" title="View" onClick={() => viewProperty(row.uniqueId)}>
                    <i className="fe fe-eye"></i>
                </button>,
                <button data-bs-toggle="tooltip" title="Delete" onClick={() => deleteProperty(row.uniqueId)}>
        ...
        <div>
            <div className="page-header">
                ...
                <div className="ms-auto pageheader-btn">
                    <Link to="/dashboard/property/add/" className="btn btn-primary btn-icon text-white me-3">
                        <span>
