...
export default function BasicDetails() {
    ...
    const onSubmit = async (values) => {
        try {
            values = { ...values, "property_description": description || property.property_description, "business_time": businessHours }
            dispatch(showLoading());
                                                    ...
                                                    showNameInInput
                                                        ...
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_name}
                                                                <button onClick={() => handleEditName()}><i className="fe fe-edit text-primary"></i></button>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                                    ...
                                                    showContactInInput
                                                        ...
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_mobile_no}
                                                                <button onClick={() => handleEditContact()} className="mx-2"><i className="fe fe-edit"></i></button>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                                    ...
                                                    showEmailInInput
                                                        ...
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_email}
                                                                <span onClick={() => handleEditEmail()} className="mx-2"><i className="fe fe-edit"></i></span>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                                    ...
                                                    showAltContactInInput
                                                        ...
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_alt_mobile_no}
                                                                <span onClick={() => handleEditAltContact()} className="mx-2"><i className="fe fe-edit"></i></span>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                    ...
                                    <div className="media-heading">
                                        <h5>
                                            ...
                                            {showDescriptionInInput
                                                ?
                                                <>
                                                    <span onClick={handleCancelEditDescription} className="mx-3 py-2"><i className="fe fe-x"></i></span>
                                                    <button type="submit" className="btn"><i className="fe fe-check text-primary"></i></button>
                                                </>

                                                :
                                                <>
                                                    <span onClick={() => handleEditDescription()} className="mx-2 py-2"><i className="fe fe-edit"></i></span>
                                                </>
                                            }
                                        </h5>
                                    </div>
                                        ...
                                        <>
                                            <p>
                                                {property.property_description && (
                                                    <span>{property.property_description.replace(/<[^>]+>/g, '')}</span>
                                                )}
                                            </p>
                                        </>
                                    }
