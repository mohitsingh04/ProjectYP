                                                    ...
                                                    showAddressInInput
                                                        ...
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_address}
                                                                <span onClick={() => handleEditAddress()} className="mx-2"><i className="fe fe-edit"></i></span>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                                    ...
                                                    showCityInInput
                                                        ...
                                                        <>
                                                            <form onSubmit={handleSubmit} className="d-flex">
                                                                ...
                                                                <span onClick={handleCancelEditCity} className="mx-3 py-2"><i className="fe fe-x"></i></span>
                                                                <button type="submit" className="btn"><i className="fe fe-check text-primary"></i></button>
                                                            </form>
                                                        </>
                                                        :
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_city}
                                                                <span onClick={() => handleEditCity()} className="mx-2"><i className="fe fe-edit"></i></span>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                                    ...
                                                    showCountryInInput
                                                        ...
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_country}
                                                                <span onClick={() => handleEditCountry()} className="mx-2"><i className="fe fe-edit"></i></span>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                                    ...
                                                    showPincodeInInput
                                                        ...
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_pincode}
                                                                <span onClick={() => handleEditPincode()} className="mx-2"><i className="fe fe-edit"></i></span>
                                                            </>
                                                        </>
                                                }
                                            </td>
                                                    ...
                                                    showStateInInput
                                                        ...
                                                        <>
                                                            <form onSubmit={handleSubmit} className="d-flex">
                                                                ...
                                                                <span onClick={handleCancelEditState} className="mx-3 py-2"><i className="fe fe-x"></i></span>
                                                                <button type="submit" className="btn"><i className="fe fe-check text-primary"></i></button>
                                                            </form>
                                                        </>
                                                        :
                                                        <>
                                                            <>
                                                                <br />
                                                                {property.property_state}
                                                                <span onClick={() => handleEditState()} className="mx-2"><i className="fe fe-edit"></i></span>
                                                            </>
                                                        </>
                                                }
                                            </td>
