...
export default function Seo() {
    ...
    const onSubmit = async (values, { resetForm }) => {
        try {
            values = { ...values, "description": description, "property_id": property.uniqueId, "property_name": property.property_name }
            dispatch(showLoading());
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <div className="ms-auto pageheader-btn">
                                {seo.length > 0 && (
                                    <>
                                        <Link to={`/dashboard/edit/seo/${seo[0].property_name}/${seo[0].uniqueId}`} className="btn btn-primary btn-icon text-white me-3">
                                            <span>
