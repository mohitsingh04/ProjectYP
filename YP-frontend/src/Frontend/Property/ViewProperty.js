                            ...
                            <Card.Body>
                                <div className="productdec text-center">
                                    <div className="bg-light-gray p-6 text-center br-5">
                                        <img
                                            alt="Product"
                                            src={`http://localhost:5000/images/${property.featured_image}`}
                                        />
                                    </div>
                                </div>
                                            ...
                                            >
                                                ...
                                                <Tab eventKey="Reviews" title="Reviews " className="me-2">
                                                    ...
                                                    <form onSubmit={handleSubmit}>
                                                        <h5 className="my-3"><strong>Review</strong></h5>
                                                        <Row>
                                                            <Col md={6}>
                                                                <div className="mb-3">
                                                                    <input
                                                                        ...
                                                                        onBlur={handleBlur}
                                                                    />
                                                                    {errors.name && touched.name ? <span className='text-danger'>{errors.name}</span> : <span />}
                                                                </div>
                                                            </Col>
                                                            <Col md={6}>
                                                                <div className="mb-3">
                                                                    <input
                                                                        ...
                                                                        onBlur={handleBlur}
                                                                    />
                                                                    {errors.email && touched.email ? <span className='text-danger'>{errors.email}</span> : <span />}
                                                                </div>
                                                            </Col>
                                                            <Col md={6}>
                                                                <div className="rating-css mb-3">
                                                                    <div className="star-icon">
                                                                        <input type="radio" name="review" onChange={handleChange} onBlur={handleBlur} value="1" id="star1" />
                                                                        <label htmlFor="star1" className="fa fa-star me-2"></label>
                                                                        <input type="radio" name="review" onChange={handleChange} onBlur={handleBlur} value="2" id="star2" />
                                                                        <label htmlFor="star2" className="fa fa-star me-2"></label>
                                                                        <input type="radio" name="review" onChange={handleChange} onBlur={handleBlur} value="3" id="star3" />
                                                                        <label htmlFor="star3" className="fa fa-star me-2"></label>
                                                                        <input type="radio" name="review" onChange={handleChange} onBlur={handleBlur} value="4" id="star4" />
                                                                        <label htmlFor="star4" className="fa fa-star me-2"></label>
                                                                        <input type="radio" name="review" onChange={handleChange} onBlur={handleBlur} value="5" id="star5" />
                                                                        <label htmlFor="star5" className="fa fa-star me-2"></label>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                            <Col md={12}>
