...
import { Row, Card, FormGroup, InputGroup, FormControl, Form, Col } from "react-bootstrap";
...
export default function Search() {
    ...
    const onChangeCategory = (e) => {
        ...
        if (e.target.checked === true) {
            setFilterData(property.filter(property => property.category === e.target.value))
    ...
    const onChangeCity = (e) => {
        if (e.target.checked === true) {
            setFilterData(property.filter(property => property.property_city === e.target.value))
    ...
    const onChangeState = (e) => {
        if (e.target.checked === true) {
            setFilterData(property.filter(property => property.property_state === e.target.value))
                                            ...
                                            <>
                                                <div class="form-check" key={key}>
                                                    <input
                                                        ...
                                                        onChange={onChangeCategory}
                                                    />
                                                    <label class="form-check-label" htmlFor={`category-${items.uniqueId}`}>
                                                        {items.category_name}
                                                    </label>
                                                </div>
                                            </>
                                        ...
                                        <FormGroup>
                                            ...
                                            {property.map((items, key) => (
                                                <div className="custom-checkbox custom-control" key={key}>
                                                    ...
                                                    />
                                                    <label htmlFor={`city-${items.uniqueId}`} className="custom-control-label">
                                                        {items.property_city}
                                                    </label>
                                                </div>
                                            ))}
                                        ...
                                        <FormGroup>
                                            ...
                                            {property.map((items, key) => (
                                                <div className="custom-checkbox custom-control" key={key}>
                                                    ...
                                                    />
                                                    <label htmlFor={`state-${items.uniqueId}`} className="custom-control-label">
                                    ...
                                    <div className="card item-card">
                                        ...
                                        <div className="product-grid6 card-body ">
                                            <div className="product-image6 ">
                                                <Link
                                                    to={`/dashboard/view/property/${items.uniqueId}`}
                                                >
                                                    <img src={`http://localhost:5000/images/${items.logo}`} className="img-fluid" alt="" />
                                                </Link>
                                                <div className="product-content text-center">
                                                    ...
                                                    <div className="price fs-6">{items.property_city}</div>
                                                </div>
                                                <ul className="icons">
                                                    <li>
                                                        <Link
