        ...
        <>
                                            ...
                                            <>
                                                <div className="search-list-container">
                                                    <ul className="search-list">
                                                        {filterData.map((item) => (
                                                            <li>
                                                                <a className="text-dark" href={`/dashboard/view/property/${item.uniqueId}`}>
                                                                    {item.property_name}
                                                                </a>
                                                            </li>
                                                        ))}
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <ul class="list-unstyled list-vertical py-3">
                                        <li><a href="#">Yoga Institute</a></li>
                                        <li><a href="#">Personnel Yoga Trainer</a></li>
                                        <li><a href="#">Yoga Courses</a></li>
                                        <li><a href="#">Find Jobs in yoga</a></li>
                                        <li><a href="#">Offers</a></li>
                                        <li><a href="#" class="text-primary">Not Sure?</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <section class="py-5 bg-white">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="site-heading mb-3">Yogprerna is the best way to find your Yoga Places</h1>
                            <p class="site-subheading mb-3">If success is a process with a number of defined steps, then it is just like any other process.</p>
                            ...
                            <ul class="highlight-points-1">
                                <li>Projects & residentials completed in 2020 workers with us </li>
                                <li>Building Relationships With Clients All Over The World! </li>
                                <li>Offering high quality construction solutions Build Your. </li>
                                <li>Building Relationships With Clients All Over The World! </li>
                                <li>Offering high quality construction solutions Build Your. </li>
                            </ul>
                            <a href="#" class="btn site-btn-2 my-3"> Join Us </a>
                        </div>
                        <div class="col-md-6">
                            <div class="feature-img-1">
                                <img src={YogaImage} alt="Yoga image" />
